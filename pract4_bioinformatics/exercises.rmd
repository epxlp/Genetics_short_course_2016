...
2. Identify interesting annotations using Haploreg
3. Use the ensembl genome browser to explore the region and visualise annotations
...
**_Questions:_**
> (1) Is there much resolution for the signal (many of few SNPs, small or large region)?

> (2) Are they all associated SNPs in high LD?
